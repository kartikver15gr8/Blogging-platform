...
// Connect to MongoDB
mongoose_1.default.connect("mongodb+srv://Kartik:M6I1SRXOHJRS3DhA@cluster0.vioh21c.mongodb.net/BlogApp", { dbName: "BlogApp" });
// mongoose.connect("mongodb://localhost:27017");
// Admins Signup
let adminSignupBody = zod_1.z.object({
    name: zod_1.z.string().min(0).max(100),
    email: zod_1.z.string().min(0).max(100),
    password: zod_1.z.string().min(0).max(100),
});
app.post("/admin/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const name = userCreds.data.name;
    ...
    if (admin) {
        ...
        newAdmin.save();
        const token = jsonwebtoken_1.default.sign({ email, role: "admin" }, SECRET_FOR_ADMIN, {
            expiresIn: "1h",
        });
        res
            .status(200)
...
// Get All Users
app.get("/admin/allusers", authenticateAdmins, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield Users.find({});
    res.status(200).send(users);
}));
// ---------------- Below are Users Routes ----------------------
// Users Signup Route
let userSignupBody = zod_1.z.object({
...
app.post("/users/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let email = userCreds.data.email;
    let name = userCreds.data.name;
    let password = userCreds.data.password;
    ...
    if (user) {
        ...
        newUser.save();
        const token = jsonwebtoken_1.default.sign({ email, role: "user" }, SECRET_KEY, {
            expiresIn: "1h",
        });
        res
            .status(200)
...
app.post("/users/craft", authenticateJWT, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Get All Blogs
app.get("/users/blogs", authenticateJWT, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
